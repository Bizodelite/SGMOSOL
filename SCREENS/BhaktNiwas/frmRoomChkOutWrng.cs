...
{
    public partial class frmRoomChkOutWrng : Form
    {
        ...
        public frmRoomChkOutWrng()
        {
            InitializeComponent();
        }

        private void frmRoomChkOutWrng_Load(System.Object sender, System.EventArgs e)
        {
            double TotalAmt = 0;
        ...
        private void FillGridView()
        {
            ...
            try
            {
                ds = objDsRoomMst.GetChkOutWarnigGrid(Convert.ToInt32(txtCounter.Tag), strDate, RoomLocID);
